...
namespace LlamAcademy.Guns.Editors
{
    ...
    public class ShootConfigScriptableObjectPropertyDrawer : PropertyDrawer
    {
        ...
        private VisualElement BuildShootConfigBox(VisualElement RootElement, SerializedProperty Property)
        {
            ...
            FloatField numberOfBulletsField = new("Number of Bullets Per Shot");
            numberOfBulletsField.BindProperty(shootConfigSO.FindProperty("BulletsPerShot"));
            shootConfigBox.Add(numberOfBulletsField);
            ...
            Vector3Field minSpreadField = new("Min Spread Range");
